/**
 * @file
 * @brief Заголовочный файл класса простых числа
 */
...
private:
    /**
     * @brief Структура, описывающая один узел списка простых чисел.
     */
    struct Node
    {
        /**
...
public:
    ...
    /**
     * @brief Функция, позволяющая узнать размер всего контейнера.
     * @return Размер объекта Node в байтах, умноженный на количество хранимых объектов
     */
    int sizeofContainer() const;
