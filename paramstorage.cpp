...
{
    // Проход с первого параметра (не с нулевого) с шагом 2
    // Нулевой параметр - имя исполняемого файла, не нужен для нахождения требуемых параметров
    // С шагом 2 - сначала берется ключ параметра, потом его значение, и так далее для всех параметров
